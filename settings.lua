data:extend(
    {
        ...
        { name = "Hide_DSR_recipes",            type = "bool-setting", default_value = false,  setting_type = "startup", order = "0500" },
        { name = "debug_logging_level",         type = "int-setting",  default_value = 0,      setting_type = "startup", order = "9999" }
    }
)
