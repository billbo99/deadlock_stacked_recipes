            ...
            if tech_table.effects then
                for _, effect in pairs(tech_table.effects) do
                    if effect.type == "unlock-recipe" then
                        if starts_with(effect.recipe, "StackedRecipe") or starts_with(effect.recipe, "deadlock-stacks-stack") or starts_with(effect.recipe, "deadlock-stacks-unstack") or starts_with(effect.recipe, "DSR_HighPressure") then
